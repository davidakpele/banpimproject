            ...
            <div class="container d-flex justify-content-center">
                ...
                <div class="col-md-6 rcol">
                    <div class="form-container" style="margin-top:100px;">
                        <form autoComplete='off' class="sign-up form-group mt-5 auth-form" action="{$root_link}auth/login" method="post">
                ...
                <p class="exist mt-4">Don't have account? <span><a href="{$root_link}auth/register">Create one</a></span></p>
            </div>
        </div>
        </div>
