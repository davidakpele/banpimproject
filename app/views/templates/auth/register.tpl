            ...
            <div class="container d-flex justify-content-center">
                ...
                <div class="col-md-6 rcol">
                    <form autoComplete='off' class="sign-up form-group auth-form" action="{$root_link}auth/register" method="post">
                        ...
                        <div class="form-group fone mt-2">
                            <i class="fas fa-user"></i>
                            <input type="text" class="form-control firstname {if $errors.firstname}is-invalid{/if}" name="firstname" placeholder="Firstname" value="{$submitted_firstname|escape:'html'}">
                        ...
                        <div class="form-group fone mt-2">
                            <i class="fas fa-user"></i>
                            <input type="text" class="form-control lastname {if $errors.lastname}is-invalid{/if}" name="lastname" placeholder="Lastname" value="{$submitted_lastname|escape:'html'}">
