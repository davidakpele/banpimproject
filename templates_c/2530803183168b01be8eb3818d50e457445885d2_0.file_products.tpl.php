<?php
/* Smarty version 5.3.1, created on 2024-06-23 23:00:31
  from 'file:products.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.3.1',
  'unifunc' => 'content_66788cef6a8642_86376819',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2530803183168b01be8eb3818d50e457445885d2' => 
    array (
      0 => 'products.tpl',
      1 => 1719176426,
      2 => 'file',
  ...
  array (
    ...
    'file:inc/sideBar.tpl' => 1,
    'file:inc/footer.tpl' => 1,
  ),
))) {
function content_66788cef6a8642_86376819 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\BanPIM\\app\\views\\templates';
...
?>
<link rel="stylesheet" href="<?php echo $_smarty_tpl->getValue('assets_link');?>
css/jquery.dataTables.min.css">
<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('assets_link');?>
...
" class="site_title"><i class="fa fa-heart"></i> <span>BanPim</span></a>
 					</div>
 					...
 					<div class="profile">
 						<div class="profile_pic">
 							<img src="<?php echo $_smarty_tpl->getValue('assets_link');?>
img/admin.png" alt="..." class="img-circle profile_img">
 						</div>
 						<div class="profile_info">
 							<span>Welcome,</span>
 							<h2><?php echo $_smarty_tpl->getValue('session_username');?>
</h2>
 						</div>
 					</div>
 					<!-- /menu profile quick info -->
 					...
 					<!-- sidebar menu -->
                    <?php $_smarty_tpl->renderSubTemplate('file:inc/sideBar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), (int) 0, $_smarty_current_dir);
?>
 					<!-- /sidebar menu -->
 				</div>
 			</div>
 						...
 						<ul class="nav navbar-nav navbar-right">
 							<li class="">
 								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
 									<img src="<?php echo $_smarty_tpl->getValue('assets_link');?>
img/admin.png" alt=""><?php echo $_smarty_tpl->getValue('session_username');?>
...
auth/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
 								</ul>
 							</li>
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo $_smarty_tpl->getValue('product')['title'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['description'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['category'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['tag'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['size'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['weight'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['sku_id'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['color'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['view_count'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('product')['download_count'];?>
</td>
												<td>
												<div style="display:flex; gap:1.10rem;">
													<a href="<?php echo $_smarty_tpl->getValue('root_link');?>
product/view_product/<?php echo $_smarty_tpl->getValue('product')['id'];?>
">
													...
													<a href="<?php echo $_smarty_tpl->getValue('root_link');?>
product/download_product/<?php echo $_smarty_tpl->getValue('product')['id'];?>
">
