<?php
/* Smarty version 5.3.1, created on 2024-06-22 22:55:21
  from 'file:auth/register.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.3.1',
  'unifunc' => 'content_66773a39e781e6_22541798',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '65c0d262b1639f96f198e65801565a51a62dba7c' => 
    array (
      0 => 'auth/register.tpl',
      1 => 1719089720,
      2 => 'file',
...
function content_66773a39e781e6_22541798 (\Smarty\Template $_smarty_tpl) {
...
">
                        ...
                        <div class="form-group fone mt-2">
                            <i class="fas fa-user"></i>
                            <input type="text" class="form-control firstname <?php if ($_smarty_tpl->getValue('errors')['firstname']) {?>is-invalid<?php }?>" name="firstname" placeholder="Firstname" value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('submitted_firstname'), ENT_QUOTES, 'UTF-8', true);?>
">
                             <div class="invalid-feedback firstname-error">
                                <?php if ($_smarty_tpl->getValue('errors')['firstname']) {?>
                                    <?php echo $_smarty_tpl->getValue('errors')['firstname'];?>
                        ...
                        <div class="form-group fone mt-2">
                            <i class="fas fa-user"></i>
                            <input type="text" class="form-control lastname <?php if ($_smarty_tpl->getValue('errors')['lastname']) {?>is-invalid<?php }?>" name="lastname" placeholder="Lastname" value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('submitted_lastname'), ENT_QUOTES, 'UTF-8', true);?>
">
                             <div class="invalid-feedback lastname-error">
                                <?php if ($_smarty_tpl->getValue('errors')['lastname']) {?>
                                    <?php echo $_smarty_tpl->getValue('errors')['lastname'];?>
