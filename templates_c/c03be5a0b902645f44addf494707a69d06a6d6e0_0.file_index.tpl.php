<?php
/* Smarty version 5.3.1, created on 2024-06-23 22:35:05
  from 'file:index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.3.1',
  'unifunc' => 'content_667886f9aed404_35922661',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c03be5a0b902645f44addf494707a69d06a6d6e0' => 
    array (
      0 => 'index.tpl',
      1 => 1719174899,
      2 => 'file',
...
function content_667886f9aed404_35922661 (\Smarty\Template $_smarty_tpl) {
 			...
 			<div class="right_col" role="main">
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box" style="background-color:#B22222; color:#fff">
                    <div class="inner">
                      <h3><?php echo $_smarty_tpl->getValue('product_count');?>
</h3>
                    ...
                    <a href="<?php echo $_smarty_tpl->getValue('root_link');?>
product/viewall" class="small-box-footer">View Products <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box" style="background-color:#d81b60 ; color:#fff">
                    <div class="inner">
                      <h3><?php echo $_smarty_tpl->getValue('media_count');?>
</h3>
                    ...
                    <a href="<?php echo $_smarty_tpl->getValue('root_link');?>
media/all" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box" style="background-color:#001f3f; color:#fff">
                    <div class="inner">
                      <h3><?php echo $_smarty_tpl->getValue('product_views');?>
</h3>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box" style="background-color:#001f3f; color:#fff">
                    <div class="inner">
                      <h3><?php echo $_smarty_tpl->getValue('downloads_count');?>
</h3>
