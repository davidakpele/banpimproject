<?php
/* Smarty version 5.3.1, created on 2024-06-23 21:20:23
  from 'file:media.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.3.1',
  'unifunc' => 'content_667875778b3927_70709406',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '489bc5f046b4fdda8b161522a94993cf9ef4c4d2' => 
    array (
      0 => 'media.tpl',
      1 => 1719170423,
      2 => 'file',
...
function content_667875778b3927_70709406 (\Smarty\Template $_smarty_tpl) {
 							...
 							<div class="x_panel">
                                <table class="table js-basic-example dataTable table-striped table-bordered table-hover" id="myTable" >
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('medias'), 'media');
$foreach0DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('media')->value) {
$foreach0DoElse = false;
?>
                                            <tr>
                                                <td><?php echo $_smarty_tpl->getValue('media')['media_name'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('media')['description'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('media')['category'];?>
</td>
                                                <td><?php echo $_smarty_tpl->getValue('media')['file_type'];?>
</td>
                                            </tr>
                                            <?php
}
